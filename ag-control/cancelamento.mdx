...
| `ag_documento` | string   | CNPJ do destinatario informado na entrada original                       |
...
```json body
{
  ...
  "observacao": "Cancelamento por divergência na nota"
}
```
...
| :--------- | :------------------------------------------ | :-------------------------------------------- |
| 400        | Campos obrigatórios ausentes                | `nf_entrada` ou `ag_documento` nulo           |
