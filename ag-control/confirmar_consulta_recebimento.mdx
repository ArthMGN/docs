...
| **Nome**             | **Tipo**   | **Descrição**                                               |
| :------------------- | :--------- | :---------------------------------------------------------- |
| `destino`            | string     | Identificador do sistema consumidor (ex: SAP, TOTVS, ETC..) |
...
| `observacao`         | observacao | Observação livre de auditoria                               |
...
| :--------- | :----------------------------------------- | :-------------------------------------------- |
| 403        | Usuário sem acesso a empresa               | Sem vínculo com empresa                       |
